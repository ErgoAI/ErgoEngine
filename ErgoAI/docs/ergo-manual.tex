...
The \emph{strong} Courteous argumentation theory is in-between the cautious and
...
rule $\rho_2$ that is itself defeated by $\rho_1$.
...
The strong argumentation theory can be requested as follows (again,
