...
\section{Disabling Advanced Features}\label{sec=disablefeature}

In some cases, the advanced features related to evaluation delay of
subgoals or to user-defined equality may need to be disabled.
...
\item \texttt{subgoal\_delay} -- disabling this makes all delayable
  builtins execute immediately. Also ignores delay quantifiers.
\end{itemize}
%% 
The following calls disable these features
%% 
\begin{itemize}
\item  \texttt{disablefeature\{attr\_vars\}}  
\item  \texttt{disablefeature\{naf\_delay\}}  
\item  \texttt{disablefeature\{defeat\_delay\}}  
\end{itemize}
%% 
and the following re-enable them:
%% 
\begin{itemize}
\item  \texttt{enablefeature\{attr\_vars\}}  
\item  \texttt{enablefeature\{naf\_delay\}}  
\item  \texttt{enablefeature\{defeat\_delay\}}  
\end{itemize}
%% 
All these features are enabled by default. For example,
%% 
\begin{verbatim}
 ....  :-  ....,                       // \naf is delayed here
