...
\item[] \textbf{Windows:} 
  ...
  \item \textbf{A note on anti-virus software:} During installation, your
    anti-virus software may ask you to 'Trust' the file. Please follow
    instructions to do so.  If at any time after installation \ERGOAI Studio
    ...
    products in particular.  To fix this, navigate to the runErgoAI.exe
